...
//   let pet = pets.filter(function(animal){
...
function ListarTipo(tipoEscolhido){

  let petsEscolhidos = pets.filter(function(pet){
    return pet.tipo == tipoEscolhido  ;
  })
  return petsEscolhidos
  ;
